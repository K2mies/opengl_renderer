...
int main (){ 
 ...
 {   
      ...
      colorShader.setSunLight("sunlight", sunlight);
      ...
      colorShader.setSpotLight("spotlight", spotlight);
      ...
      for (int i = 0; i < 4; i++)
      {
        ...
        colorShader.setPointLight("pointlights[" + std::to_string(i) + "]", pointlights[i]);
      }
